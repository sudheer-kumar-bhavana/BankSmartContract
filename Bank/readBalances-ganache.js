...
const balAddress1 = '0xE5160e414bc10afe0f43183C40592ec1ac0359bb';
const balAddress2 = '0x622bB130077a58590E856b2d4F93aB35364022A6';

const nonOwner = '0x622bB130077a58590E856b2d4F93aB35364022A6';
...
contract.methods.balance(balAddress1)
.call({from: admin}, (err, res) => {   
   if(!err) console.log(web3.utils.fromWei(res) +' ETH');
});

contract.methods.balance(balAddress2)
.call({from: admin}, (err, res) => {   
   if(!err) console.log(web3.utils.fromWei(res) +' ETH');
});
